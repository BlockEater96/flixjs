...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/OmniFlix.streampay.v1.MsgStreamSend", MsgStreamSend], ["/OmniFlix.streampay.v1.MsgStopStream", MsgStopStream], ["/OmniFlix.streampay.v1.MsgClaimStreamedAmount", MsgClaimStreamedAmount], ["/OmniFlix.streampay.v1.MsgUpdateParams", MsgUpdateParams]];
